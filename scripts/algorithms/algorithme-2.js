  ...
  getShowTags( arrayTags2Ingredients, arrayTags2Appliances, arrayTags2Ustensils, mapIngredients, mapAppareils, mapUstensils ) {
    ...
    liIngredient.forEach((btn) =>
      btn.addEventListener("click", (e) => {
        ...
        newelementSearc.innerHTML = `<p style="margin:5px;">${e.currentTarget.textContent}</p>
                                      <i class="close1 fa-solid fa-xmark" id="${e.currentTarget.textContent}" style="margin:10px; cursor:pointer;"></i>`;
