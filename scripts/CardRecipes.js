class CardRecipes {
  constructor() {
    ...
    this.containerElementsIngredient = document.querySelector(
      ".container-elements-ingredient"
    );
    this.containerElements2Ingredient = document.querySelector(
      ".container-elements2-ingredient"
    );
    this.containerElementsAppareils = document.querySelector(
      ".container-elements-appareils"
    );
    this.containerElements2Appareils = document.querySelector(
      ".container-elements2-appareils"
    );
    this.containerElementsUstensils = document.querySelector(
      ".container-elements-ustensils"
    );
    this.containerElements2Ustensils = document.querySelector(
      ".container-elements2-ustensils"
    );
  ...
  async displayData() {
    ...
    cardsRecipes.recipes.map((el) => {
      let ingredients = el.ingredients
        .map((elt) => {
          return `<p class="m-0"><b>${elt.ingredient}</b> ${
    ...
    const algo2 = new Algorithme( this.recipesSection, this.arrayRecipes, cardsRecipes.recipes, this.arrayUstensilsTags );
    ...
    algo2.getRecipesBarSearch( this.mapIngredients, this.arrayTags2[0], this.mapAppareils, this.arrayTags2[1], this.mapUstensils, this.arrayTags2[2] );
    ...
    algo2.getListTags( this.arrayTags[0], this.arrayTags2[0], this.containerElementsIngredient, this.containerElements2Ingredient, this.chevronIngredients, this.chevronClickIngredient, this.mapIngredients, "ingredients", this.checkInputIngredients );
    algo2.getListTags( this.arrayTags[1], this.arrayTags2[1], this.containerElementsAppareils, this.containerElements2Appareils, this.chevronAppareils, this.chevronClickAppareils, this.mapAppareils, "appareils", this.checkInputAppareils );
    algo2.getListTags( this.arrayTags[2], this.arrayTags2[2], this.containerElementsUstensils, this.containerElements2Ustensils, this.chevronUstensils, this.chevronClickUstensils, this.mapUstensils, "ustensils", this.checkInputUstensils );
    ...
    algo2.getShowTags( this.arrayTags2[0], this.arrayTags2[1], this.arrayTags2[2], this.mapIngredients, this.mapAppareils, this.mapUstensils );
  }
}
